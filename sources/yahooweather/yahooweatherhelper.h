...
#ifndef YAHOO_FORECAST_URL
#define YAHOO_FORECAST_URL "https://query.yahooapis.com/v1/public/yql?format=json&q=select * from weather.forecast where u='c' and woeid in (select woeid from geo.places(1) where text='%2, %3')"
#endif /* YAHOO_FORECAST_URL */
