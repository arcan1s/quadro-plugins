...
#ifndef YAHOOWEATHERSETTINGS_H
#define YAHOOWEATHERSETTINGS_H
...
class YahooWeatherSettings : public QWidget
{
    Q_OBJECT

public:
    explicit YahooWeatherSettings(QWidget *parent = nullptr);
    virtual ~YahooWeatherSettings();
...
private:
    Ui::YahooWeatherSettings *ui;
    void init(const QVariantHash &configuration);
};


#endif /* OPENWEATHERSETTINGS_H */
